...
//                       <http://www.xoops.org/>                             //
//  ------------------------------------------------------------------------ //
//    This search function is based on search functions from official	
//    XOOPS modules. 
//    Assembling link to a comment is based on code included in function 
//    b_system_comments_show in /modules/system/blocks/system_blocks.php
//    
//    Copyrights regarding the above code apply also to this code.
//    
//    Author: Kaper, kaper@zk-p.pl, http://kaper.zk-p.pl
//
// ------------------------------------------------------------------------- //
